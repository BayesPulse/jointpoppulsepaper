...
The data in this directory is the simdata_example data.  

The results show weak or non-convergence of a number of population level
parameters.
...
common_lh  <- common_lh %>% cleanchains_popcommon(trim=1000)
common_fsh <- common_fsh %>% cleanchains_popcommon(trim=1000)
